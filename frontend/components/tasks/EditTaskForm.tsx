...
/**
 * EditTaskForm component for updating existing tasks
 * User Story 4: Update Task Details (T067-T074)
 */
export function EditTaskForm({ task, onSuccess, onCancel }: EditTaskFormProps) {
  ...
  return (
    ...
    >
      {/* Title field */}
      <div>
        <label htmlFor="edit-title" className="block text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5 ml-1">
        ...
        />
        {errors.title && (
          <p id="edit-title-error" className="mt-1.5 text-sm text-red-600 dark:text-red-400 flex items-center gap-1" role="alert">
      ...
      {/* Description field */}
      <div>
        <label htmlFor="edit-description" className="block text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5 ml-1">
          Description
        </label>
        <textarea
          id="edit-description"
        ...
        />
        {errors.description && (
          <p id="edit-description-error" className="mt-1.5 text-sm text-red-600 dark:text-red-400 flex items-center gap-1" role="alert">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
              <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
            </svg>
      ...
      <div className="flex gap-3 pt-2">
        <button
          ...
          aria-label={isLoading ? "Updating task" : "Update task"}
        >
          {isLoading ? (
